...
public class DiscussionRepository {
    ...
    public List<DiscussionDTO> findByCourseId(String courseId) {
       ...
       return mapper.query(DiscussionEntity.class,queryExpression).stream().map((entity)->modelMapper.map(entity,DiscussionDTO.class)).toList();
    }
    ...
    {
        return modelMapper.map(mapper.load(DiscussionEntity.class,id), DiscussionDTO.class);
    }
}
